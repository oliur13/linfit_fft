...
%% assign 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% COULD WE HAVE  MADE THIS A LOOP OR AUTOMATED OR COMMAND LINE ARG?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Roll=inter.Roll;
% Tilt=inter.Tilt;
% Shift=inter.Shift;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% IF THE HDF is "self describing" they why do I have to write all of this?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% AGAIN IF THE HDF is "self describing" they why do I have to write all of this?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

data=vertcat(inter.Tilt,inter.Roll,inter.Twist,inter.Shift,inter.Slide,inter.Rise);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
%% CAUTION THIS IS VERY BAD PRACTICE
%% these are 73, 147,6 are "magic" numbers
...
skip=10;
    ...
    data2=data(:,mintime:skip:maxtime);
