...
xrange = xvals;%linspace(-73,73,176);
norm = range(xrange);
...
%% now what??? 
% Pick (0:n) where n are the n number of the best wavenumbers
% wavenums = nonzeros(B(end-(0:4))-1)
% wavenums = B(A>minamp)
% fftfilter= zeros(size(fftdat'));
% % Creation of the FFT Filter
